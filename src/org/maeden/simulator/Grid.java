...
//maedgraphics*/
{
    ...
    public Grid(String filePath, int approxWidth, boolean showD) throws FileNotFoundException, IOException {
        try {
            ...
            //exit if cannot use the port number
            RUN_SIM = false;
        }
    ...
    public void run() {
        ...
        System.out.println("cleanClosing");
        cleanClose();
        System.out.println("cleanClosed");
        return;
    }
    ...
    class AgentListener extends Thread {
        ...
        public void run() {
            ...
            while(RUN_SIM == true) {
                ...
                //catch (SocketException e) { System.out.println("AgentListener.run(): timeout occurred " + e); }
                catch (Exception e) {
